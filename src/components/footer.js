      ...
      <section>
        <div>
          <form action="">
            <div className="  grid-cols-1 grid items-center justify-center gap-4 md:grid-cols-3 ">
              ...
              <div
                className="relative md:mb-6 email_position style4 b bg-zinc-300 rounded-xl"
        ...
        <div class="mb-20 Footer_selector Footer_style_font">
          ...
          <ul class="mb-0  list-none">
            ...
            <li>
              <h href="https://papers.moi.technology/docs/lite-paper.pdf" class="text-white">
                Whitepaper
              </h>
            </li>
            <li>
              <h href="#!" class="text-white">
                Airdrop
              </h>
            </li>
          </ul>
          ...
          <div className="max-w-screen-xl p-4 py-4 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
              <p className="footer_typo text-white">
                MOI is a transformational p2p protocol and an open network that empowers its users to dynamically
                control their identity, storage and digital assets based on their unique needs.
              </p>
            </div>
            <div>
